<div class="my-5 d-flex jutify-content-center flex-column align-items-center">
    ...
    <button class="btn btn-lg btn-primary" wire:click='reinicio'>Reiniciar cuenta</button>
</div>
